...
async def get_title(i):
    ...
    url = 'https://job.yahoo.co.jp/jobs/?&keyword=LPIC&l=東京都&page={0}&ssid=25158ae9-0705-4dd3-85a3-30a1930eb123&comp=1'.format(i)
    ...
    try:
        cursor.executemany('insert into Tokyo_LPIC_locInfo (lcinfo) values (%s)', big_list)
        connection.commit()
        connection.close()
        print('向MySQL中添加数据成功！')
    except TypeError :
...
# create table Tokyo_LPIC_locInfo(
