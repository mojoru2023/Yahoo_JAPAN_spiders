...
def get_first_page():
    ...
    url = 'https://job.yahoo.co.jp/jobs/java%E9%96%A2%E9%80%A3%E3%81%AE%E6%B1%82%E4%BA%BA-%E6%9D%B1%E4%BA%AC%E9%83%BD'
    driver.get(url)
...
def insertDB(content):
    ...
    try:
        cursor.executemany('insert into yahoo_java_jobs (job_name,link,info1,short_info,info_from) values (%s,%s,%s,%s,%s)', content)
        connection.commit()
        connection.close()
        print('向MySQL中添加数据成功！')
