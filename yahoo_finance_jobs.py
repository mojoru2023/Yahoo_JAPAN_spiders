...
def get_first_page():
    ...
    url = 'https://job.yahoo.co.jp/jobs/%E9%87%91%E8%9E%8D%E9%96%A2%E9%80%A3%E3%81%AE%E6%B1%82%E4%BA%BA-%E6%9D%B1%E4%BA%AC%E9%83%BD?ssid=aa30174a-e645-4467-898a-03d30d28eac9'
    driver.get(url)
...
def insertDB(content):
    ...
    try:
        cursor.executemany('insert into yahoo_finance_jobs (job_name,link,info1,short_info,info_from) values (%s,%s,%s,%s,%s)', content)
        connection.commit()
        connection.close()
        print('向MySQL中添加数据成功！')
...
# #
# create table yahoo_finance_jobs(
